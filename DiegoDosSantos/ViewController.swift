...
//  DiegoDosSantos
//
//  Created by Diego dos Santos on 4/14/15.
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var url = NSBundle.mainBundle().URLForResource("myInfo", withExtension: "plist")
        ...
        imageView.image = UIImage(named: "diegoPic")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var cell = tableView.dequeueReusableCellWithIdentifier("titleCell") as! TitleTableViewCell
        ...
        if indexPath.row == 7{
            var cell = tableView.dequeueReusableCellWithIdentifier("projectsCell") as! ProjectsTableViewCell
            cell.detailView.backgroundColor = setDetailColorText(indexPath)
            cell.label1.text = "RoundTrip"
            cell.label1.font = UIFont(name: "HelveticaNeue-Thin", size: 16)
            cell.label2.text = "Colaborê"
            cell.label2.font = UIFont(name: "HelveticaNeue-Thin", size: 16)
            cell.label3.text = "RoutineTask"
            cell.label3.font = UIFont(name: "HelveticaNeue-Thin", size: 16)
            cell.label4.text = "SICCE"
            cell.label4.font = UIFont(name: "HelveticaNeue-Thin", size: 16)
            cell.button1.tag = 1
            cell.button2.tag = 2
            cell.button3.tag = 3
            cell.button4.tag = 4
            ...
            self.setButtonCustom(cell.button3)
            self.setButtonCustom(cell.button4)
            return cell
        }
        if indexPath.row == 1{
            var cell = tableView.dequeueReusableCellWithIdentifier("aboutCell") as! AboutTableViewCell
            cell.detailView.backgroundColor = setDetailColorText(indexPath)
        ...
        var cell = tableView.dequeueReusableCellWithIdentifier("textCell") as! TextTableViewCell
        cell.detailView.backgroundColor = setDetailColorText(indexPath)
        cell.textView.text = setText(indexPath)
        cell.textView.scrollRangeToVisible(NSMakeRange(0, 0))
        cell.textView.font = UIFont(name: "HelveticaNeue-Thin", size: 16)
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if indexPath != selectedIndexPath{
            ...
            if indexPath.row == 10{
                var cell = tableView.cellForRowAtIndexPath(indexPath) as! TitleTableViewCell
                cell.secondView.backgroundColor = setDetailColor(indexPath)
            }
        }else{
            if indexPath.row == 10{
    ...
    func setText(indexPath: NSIndexPath) -> String{
        var me = myInfo.objectForKey("me") as! NSDictionary
        var background = myInfo.objectForKey("background") as! NSDictionary
        var experiences = myInfo.objectForKey("experiences") as! NSDictionary
        var interests = myInfo.objectForKey("interests") as! NSDictionary
        var dreams = myInfo.objectForKey("dreams") as! NSDictionary
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "projectSegue"{
           ...
           var vc = dvc.viewControllers[0] as! ProjectViewController
            var tagindex = (sender as! UIButton).tag
            if tagindex == 1{
                vc.id = "roundtrip"
            }else if tagindex == 2{
                vc.id = "colabore"
        ...
        if segue.identifier == "webViewSegue"{
            ...
            var ident = senderButton.restorationIdentifier
            var dvc = segue.destinationViewController as! UINavigationController
            var wvc = dvc.viewControllers[0] as! WebViewController
            var me = myInfo.objectForKey("me") as! NSDictionary
            ...
            if ident == "facebook"{
               wvc.urlString = me.valueForKey("facebook") as! String
                ...
                wvc.urlString = me.valueForKey("linkedin") as! String
                wvc.titleWeb = "Linkedin"
            }
        }
    }
}
